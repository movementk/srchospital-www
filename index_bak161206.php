...
<style>
.list_con						{width:100%;padding:20px 0 20px 0; border-bottom:1px #d8d8d8 solid; overflow:hidden;}
	...
	<main id="content">
		...
		<div class="key-contents">
			<div class="container-fluid">
				<div class="row">
					<section class="col-xs-6 staff" style="cursor:pointer;">
				...
				<div class="row">
					<div class="col-xs-8">
						<section class="news">
							...
							<ol>
								<?
								$sql = "select * from ".$site_prefix."board_notice where 1=1 order by BoardIdx desc limit 0, 5";
								$result = sql_query($sql);
								for($i=0;$row = sql_fetch_array($result);$i++){
									switch($row["Category"]){
										case "공지":
							...
							<a href="/community/news_list.php"><span class="glyphicon glyphicon-plus"></span><span class="sr-only"></span></a>
						</section>
					</div>
					<div class="col-xs-4">
						<div class="review">
				...
				<div class="row">
					<div class="col-xs-4">
						<section class="bus">
							...
							<a href="/introduce/bus.php">노선표 보러가기</a>
						</section>
					</div>
					<div class="col-xs-4">
						<?
